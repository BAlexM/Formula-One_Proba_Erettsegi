...
function calculate() {
    ...
    if ( track === 'HUN' ) document.getElementById('averagespeed').value = 4.381 / laptime + ' km/h';
    else if ( track === 'MON' ) document.getElementById('averagespeed').value = 3.337 / laptime + ' km/h';
    else if ( track === 'BEL' ) document.getElementById('averagespeed').value = 7.004 / laptime + ' km/h';
    else if ( track === 'ITA' ) document.getElementById('averagespeed').value = 5.793 / laptime + ' km/h';
  }
